...
namespace TelegramBot
{
    internal class TelegraBotHelper
    {
        ...
        private const string History = "История заказа";
                ...
                case UpdateType.Message:
                    ...
                    var clientMessage = _clientStates[msgChatId];
                    {
                        switch (text)
                        {
                            ...
                            case History:
                                var messageHistory = "История заказы:\n";
                                var i = 0;
                ...
                case UpdateType.CallbackQuery:
                    ...
                    switch (update.CallbackQuery.Data)
                    {
                        ...
                        case Order:
                            ...
                            await botClient.SendTextMessageAsync(callChatId, "Ваш заказ принят, ожидайте доставку");
                            break;
